      ...
      <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-6">
        ...
        <div class="flex flex-col md:flex-row gap-8">
          ...
          <div class="flex flex-col gap-3">
            ...
            <nav class="flex flex-col gap-1">
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] group block"><span class="block relative overflow-hidden h-[22.72px]"><span class="block transition-transform duration-300 ease-in-out group-hover:-translate-y-full whitespace-nowrap">Design Template 8Oz Single Wall Custom Cup</span><span class="block absolute inset-x-0 top-full transition-transform duration-300 ease-in-out group-hover:-translate-y-full text-[#ea580c] whitespace-nowrap">Design Template 8Oz Single Wall Custom Cup</span></span></a>
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] group block"><span class="block relative overflow-hidden h-[22.72px]"><span class="block transition-transform duration-300 ease-in-out group-hover:-translate-y-full whitespace-nowrap">Design Template 8Oz Double Wall Custom Cup</span><span class="block absolute inset-x-0 top-full transition-transform duration-300 ease-in-out group-hover:-translate-y-full text-[#ea580c] whitespace-nowrap">Design Template 8Oz Double Wall Custom Cup</span></span></a>
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] group block"><span class="block relative overflow-hidden h-[22.72px]"><span class="block transition-transform duration-300 ease-in-out group-hover:-translate-y-full whitespace-nowrap">Design Template 12Oz Single Wall Custom Cup</span><span class="block absolute inset-x-0 top-full transition-transform duration-300 ease-in-out group-hover:-translate-y-full text-[#ea580c] whitespace-nowrap">Design Template 12Oz Single Wall Custom Cup</span></span></a>
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] group block"><span class="block relative overflow-hidden h-[22.72px]"><span class="block transition-transform duration-300 ease-in-out group-hover:-translate-y-full whitespace-nowrap">Design Template 12Oz Double Wall Custom Cup</span><span class="block absolute inset-x-0 top-full transition-transform duration-300 ease-in-out group-hover:-translate-y-full text-[#ea580c] whitespace-nowrap">Design Template 12Oz Double Wall Custom Cup</span></span></a>
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] group block"><span class="block relative overflow-hidden h-[22.72px]"><span class="block transition-transform duration-300 ease-in-out group-hover:-translate-y-full whitespace-nowrap">Design Template 16Oz Single Wall Custom Cup</span><span class="block absolute inset-x-0 top-full transition-transform duration-300 ease-in-out group-hover:-translate-y-full text-[#ea580c] whitespace-nowrap">Design Template 16Oz Single Wall Custom Cup</span></span></a>
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] group block"><span class="block relative overflow-hidden h-[22.72px]"><span class="block transition-transform duration-300 ease-in-out group-hover:-translate-y-full whitespace-nowrap">Design Template 16Oz Double Wall Custom Cup</span><span class="block absolute inset-x-0 top-full transition-transform duration-300 ease-in-out group-hover:-translate-y-full text-[#ea580c] whitespace-nowrap">Design Template 16Oz Double Wall Custom Cup</span></span></a>
            </nav>
          </div>
