      ...
      <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-6">
        ...
        <div class="flex flex-col md:flex-row gap-8">
          ...
          <div class="flex flex-col gap-3">
            ...
            <nav class="flex flex-col gap-1">
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] hover:text-[#ea580c] transition-colors duration-150 block">Design Template 8Oz Single Wall Custom Cup</a>
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] hover:text-[#ea580c] transition-colors duration-150 block">Design Template 8Oz Double Wall Custom Cup</a>
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] hover:text-[#ea580c] transition-colors duration-150 block">Design Template 12Oz Single Wall Custom Cup</a>
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] hover:text-[#ea580c] transition-colors duration-150 block">Design Template 12Oz Double Wall Custom Cup</a>
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] hover:text-[#ea580c] transition-colors duration-150 block">Design Template 16Oz Single Wall Custom Cup</a>
              <a href="#" class="px-3 py-2 text-[16px] text-[#334155] leading-[22.72px] hover:text-[#ea580c] transition-colors duration-150 block">Design Template 16Oz Double Wall Custom Cup</a>
            </nav>
          </div>
